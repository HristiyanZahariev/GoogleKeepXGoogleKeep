...
<pre><code class="lang-bash"><code class="source-code prettyprint">$ npm install --save sequelize
...
<pre><code class="lang-js"><code class="source-code prettyprint">var sequelize = new Sequelize(&apos;database&apos;, &apos;username&apos;, &apos;password&apos;, {
  host: &apos;localhost&apos;,
...
<p>You can use the <code>.authenticate()</code> function like this to test the connection.</p>
<pre><code><code class="source-code prettyprint">sequelize
  .authenticate()
  .then(function(err) {
...
</code></pre><h2 id="your-first-model">Your first model</h2>
...
<pre><code class="lang-js"><code class="source-code prettyprint">var sequelize = new Sequelize(&apos;connectionUri&apos;, {
  define: {
...
<p>Sequelize uses promises to control async control-flow. If you are unfamiliar with how promises work, don&apos;t worry, you can read up on them <a href="https://github.com/wbinnssmith/awesome-promises">here</a> and <a href="http://bluebirdjs.com/docs/why-promises.html">here</a>.</p>
...
<pre><code class="lang-js"><code class="source-code prettyprint">User.findOne().then(function (user) {
