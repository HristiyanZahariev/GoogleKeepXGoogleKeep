...
<div class="content" data-ice="content"><div class="github-markdown">
  ...
  <div data-ice="content"><h1 id="hooks">Hooks</h1>
...
<pre><code><code class="source-code prettyprint">(1)
...
<pre><code class="lang-js"><code class="source-code prettyprint">// Method 1 via the .define() method
...
<pre><code class="lang-js"><code class="source-code prettyprint">var Book = sequelize.define(&apos;book&apos;, {
...
<h3 id="sequelize-options-define-default-hook-">Sequelize.options.define (default hook)</h3>
<pre><code class="lang-js"><code class="source-code prettyprint">var sequelize = new Sequelize(..., {
    define: {
        hooks: {
...
<h3 id="sequelize-addhook-permanent-hook-">Sequelize.addHook (permanent hook)</h3>
<pre><code class="lang-js"><code class="source-code prettyprint">sequelize.addHook(&apos;beforeCreate&apos;, function () {
    // Do stuff
});</code>
</code></pre>
...
<pre><code><code class="source-code prettyprint">beforeValidate
...
<pre><code class="lang-js"><code class="source-code prettyprint">User.create({username: &apos;Not a Boss&apos;, accessLevel: 20}).catch(function(err) {
  console.log(err) // You can&apos;t grant this user an access level above 10!
})</code>
</code></pre>
<p>The following example would return successful:</p>
<pre><code class="lang-js"><code class="source-code prettyprint">User.create({username: &apos;Boss&apos;, accessLevel: 20}).then(function(user) {
...
<pre><code><code class="source-code prettyprint">beforeBulkCreate / beforeBulkUpdate / beforeBulkDestroy
...
<pre><code class="lang-js"><code class="source-code prettyprint">Model.beforeBulkCreate(function(records, fields) {
...
<pre><code><code class="source-code prettyprint">// Bulk updating existing users with updatesOnDuplicate option
...
<pre><code class="lang-js"><code class="source-code prettyprint">var Projects = sequelize.define(&apos;projects&apos;, {
  title: DataTypes.STRING
})
