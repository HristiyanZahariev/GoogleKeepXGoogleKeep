...
<div class="content" data-ice="content"><div class="github-markdown">
  ...
  <div data-ice="content"><h1 id="scopes">Scopes</h1>
...
<pre><code class="lang-js"><code class="source-code prettyprint">var DeletedProjects = Project.scope(&apos;deleted&apos;);
...
<p>When calling <code>post.getComments()</code>, this will automatically add <code>WHERE commentable = &apos;post&apos;</code>. Similarly, when adding new comments to a post, <code>commentable</code> will automagically be set to <code>&apos;post&apos;</code>. The association scope is meant to live in the background without the programmer having to worry about it - it cannot be disabled. For a more complete polymorphic example, see <a href="./manual/associations/#scopes">Association scopes</a></p>
...
<pre><code class="lang-js"><code class="source-code prettyprint">var Post = sequelize.define(&apos;post&apos;, attributes, {
  defaultScope: {
    where: {
      active: true
    }
