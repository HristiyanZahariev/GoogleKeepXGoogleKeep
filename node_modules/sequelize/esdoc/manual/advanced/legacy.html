...
<div class="content" data-ice="content"><div class="github-markdown">
  ...
  <div data-ice="content"><h1 id="working-with-legacy-tables">Working with legacy tables</h1>
<p>While out of the box Sequelize will seem a bit opinionated it&apos;s trivial to both legacy and forward proof your application by defining (otherwise generated) table and field names.</p>
...
<pre><code class="lang-js"><code class="source-code prettyprint">sequelize.define(&apos;modelName&apos;, {
  userId: {
...
<pre><code class="lang-js"><code class="source-code prettyprint">sequelize.define(&apos;collection&apos;, {
  uid: {
    type: Sequelize.INTEGER,
    primaryKey: true,
...
<pre><code class="lang-js"><code class="source-code prettyprint">// 1:1
