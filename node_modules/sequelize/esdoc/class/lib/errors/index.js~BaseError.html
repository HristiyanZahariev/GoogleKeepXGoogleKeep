...
<head>
  ...
  <title data-ice="title">BaseError |  Sequelize | The node.js ORM for PostgreSQL, MySQL, SQLite and MSSQL API Document</title>
...
<div class="content" data-ice="content"><div class="header-notice">
  ...
  <span data-ice="source">| <span><a href="file/lib/errors/index.js.html#lineNumber10">source</a></span></span>
</div>

<div class="self-detail detail">
  <h1 data-ice="name">BaseError</h1>

  

  
  
  <div class="flat-list" data-ice="extendsChain"><h4>Extends:</h4><div><span>Error</span> &#x2192; BaseError</div></div>
  <div class="flat-list" data-ice="directSubclass"><h4>Direct Subclass:</h4><div><span><a href="class/lib/errors/index.js~AssociationError.html">AssociationError</a></span>, <span><a href="class/lib/errors/index.js~ConnectionError.html">ConnectionError</a></span>, <span><a href="class/lib/errors/index.js~DatabaseError.html">DatabaseError</a></span>, <span><a href="class/lib/errors/index.js~EagerLoadingError.html">EagerLoadingError</a></span>, <span><a href="class/lib/errors/index.js~EmptyResultError.html">EmptyResultError</a></span>, <span><a href="class/lib/errors/index.js~InstanceError.html">InstanceError</a></span>, <span><a href="class/lib/errors/index.js~OptimisticLockError.html">OptimisticLockError</a></span>, <span><a href="class/lib/errors/index.js~QueryError.html">QueryError</a></span>, <span><a href="class/lib/errors/index.js~SequelizeScopeError.html">SequelizeScopeError</a></span>, <span><a href="class/lib/errors/index.js~ValidationError.html">ValidationError</a></span></div></div>
  <div class="flat-list" data-ice="indirectSubclass"><h4>Indirect Subclass:</h4><div><span><a href="class/lib/errors/index.js~AccessDeniedError.html">AccessDeniedError</a></span>, <span><a href="class/lib/errors/index.js~ConnectionRefusedError.html">ConnectionRefusedError</a></span>, <span><a href="class/lib/errors/index.js~ConnectionTimedOutError.html">ConnectionTimedOutError</a></span>, <span><a href="class/lib/errors/index.js~ExclusionConstraintError.html">ExclusionConstraintError</a></span>, <span><a href="class/lib/errors/index.js~ForeignKeyConstraintError.html">ForeignKeyConstraintError</a></span>, <span><a href="class/lib/errors/index.js~HostNotFoundError.html">HostNotFoundError</a></span>, <span><a href="class/lib/errors/index.js~HostNotReachableError.html">HostNotReachableError</a></span>, <span><a href="class/lib/errors/index.js~InvalidConnectionError.html">InvalidConnectionError</a></span>, <span><a href="class/lib/errors/index.js~TimeoutError.html">TimeoutError</a></span>, <span><a href="class/lib/errors/index.js~UniqueConstraintError.html">UniqueConstraintError</a></span></div></div>
  ...
  <div class="description" data-ice="description"><p>Sequelize provides a host of custom error classes, to allow you to do easier debugging. All of these errors are exposed on the sequelize object and the sequelize constructor.
All sequelize errors inherit from the base JS error object.</p>
<p>This means that errors can be accessed using <code>Sequelize.ValidationError</code> or <code>sequelize.ValidationError</code>
